...
class DefaultConfig():
    ...
    # file_root = '/home/sar/yolo/input/VOC2012/JPEGImages/'  #VOC2012的训练集
    # test_root= '/home/sar/yolo/input/VOC2007/JPEGImages/'  #VOC2012的训练集
    file_root = os.path.join(root, 'input/VOC2012/JPEGImages/')  #VOC2012的训练集
    test_root = os.path.join(root, 'input/VOC2007/JPEGImages/')  #VOC2012的训练集
    # file_root = os.path.join(root, 'input/VOC2012/JPEGImages/')  #VOC2012的训练集
    # test_root= '/home/sar/yolo/input/VOC2007/JPEGImages/'  #VOC2012的训练集
    ...
    train_Annotations = os.path.join(root, 'input/VOC2012/Annotations')
    test_Annotations = os.path.join(root, 'input/VOC2007/Annotations')
    ...
    test_img_dir = os.path.join(root, 'input', 'VOC2007', 'JPEGImages', '*.jpg')
    # test_img_dir = os.path.join(root, 'test_imgs', '2007_000170.jpg')
    # result_img_dir = os.path.join(root, 'test_imgs', 'ret.jpg')
    result_img_dir = os.path.join(root, 'test_rets')
    ...
    # load_model_path = None# 加载预训练的模型的路径，为None代表不加载
    load_model_path = os.path.join(root, 'checkpoint', 'yolo_val_best.pth')# 加载预训练的模型的路径，为None代表不加载
